...
if __name__ == '__main__':
    start = time.time()
    Base_Path = Path("X:\\comma_group1\\Rom\\dat\\AaronsTraining\\Elec_Price\\Cluster_Optimisation\\1_Feb_17---31_Dec_17")
    store_name = "Store"
    Source = 'Data.csv'
    Clustered_Source = 'Clustered_Data.csv'
    clustering = pre_cluster_step(Base_Path, Source, cutoff='acceleration')
    store = store_and_fold(Base_Path, Clustered_Source, store_name, 1)
